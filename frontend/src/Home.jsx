...
//intiataion de donnés 
  const [productData, setProductData] = useState([]);
//selecion categorie qui va affiché par défaut
  const [selectedCategory, setSelectedCategory] = useState('pizzas');
//créationn de catgories 
const categories = [
  {
    name: "pizzas",
...
//-récupération de tous les donnés :
  useEffect(() => {
  ...
  //affichage de donnés par categories séléctionnés :
  return (
    <LayoutApp>
